...
.config(['$routeProvider', function($routeProvider) {
	...
	$routeProvider
		...
		//.when('/profile/:profile_name', {templateUrl:_view_+'app/profile.html'})
		.when('/company/profile', 		{templateUrl:_view_+'app/profile.html'})
		.when('/company/profile/:profile_ID', {templateUrl:_view_+'app/profile.html'})
		
		//.when('/tender/buyer', 				{templateUrl:_view_+_tender_+'buyer.html'})
		//.when('/tender/nda', 				{templateUrl:_view_+_tender_+'nda.html'})
		//.when('/tender/supplier', 			{templateUrl:_view_+_tender_+'supplier.html'})
		.when('/tender/search/:search_ID', 	{templateUrl:_view_+'tender/search.html'})
		.when('/tender/edit/:tender_ID', 	{templateUrl:_view_+'tender/edit.html'})	// edit/0 for new
		.when('/tender/view/:tender_ID', 	{templateUrl:_view_+'tender/view.html'})
		.when('/tender/:tender_ID', 		{templateUrl:_view_+'tender/view.html'})
